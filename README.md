...
A separate opt-in [discharge diagnostic](docs/battery-discharge-test.md) can shut
down the Pi. The normal installers do not enable this diagnostic unit.
...
Use `python -m timelapse` for the maintained application. `main.py --test` remains
a compatibility dry run.
